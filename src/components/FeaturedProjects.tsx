...
const projectsData = [
  {
    ...
    title: "Cybersecurise",
    description: "แอปพลิเคชันมือถือป้องกันภัยมิจฉาชีพ มี 5 ฟีเจอร์หลัก: สแกนการตั้งค่าเครื่องที่อาจเป็นอันตราย, สแกนแอปพลิเคชันและตรวจสอบสิทธิ์การเข้าถึงเพื่อประเมินความเสี่ยงอันตราย, ตรวจจับ SMS Scam/Spam/OTP ด้วย AI/NLP, แบบทดสอบความรู้ด้านความปลอดภัย, ตรวจสอบเลขบัญชี/เบอร์โทร/ชื่อ ใน Blacklist ผ่าน CheckGon และ ChaladOhn — ผ่านเข้ารอบชิงระดับประเทศ NSC 2024 พร้อมรับเงินสนับสนุนจาก NECTEC และ NSTDA",
    tags: ["NSC 2024 Finalist", "Anti-Fraud", "Android Native", "AI/NLP"],
    languages: [
    ...
    githubUrl: "https://github.com/gong-sn-ix-ii/Cybersecurise",
    demoUrl : "",
